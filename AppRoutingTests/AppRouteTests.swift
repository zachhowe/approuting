...
class AppRouteTests: XCTestCase {
    ...
    func testRouteWithValidRoutePattern() {
        ...
        do {
            let route1 = try AppRoute(routePattern: "/burrito/:burrito_id:")
            ...
            XCTFail("Error creating AppRoute: \(error)")
        }
        
        do {
            let route2 = try AppRoute(routePattern: "/burrito/:burrito_id:/cheese/:cheese_name:/addToCart")
    ...
    func testRouteWithInvalidRoutePattern() {
        do {
            let _ = try AppRoute(routePattern: ":/burrito/:burrito_id/_id:/fds/cheese_name:/adaaald:::")
